  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          className={cn(
            'absolute z-50 px-3 py-2 text-sm font-medium text-white bg-gray-900 dark:bg-gray-100 dark:text-gray-900 rounded-lg shadow-lg whitespace-nowrap animate-fade-in',
