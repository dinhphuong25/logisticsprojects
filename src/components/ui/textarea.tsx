...
export const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, label, error, icon: Icon, showCount, maxLength, ...props }, ref) => {
    ...
    return (
      <div className="w-full space-y-2">
        ...
        <div className="relative">
          <textarea
            className={cn(
              "flex min-h-[120px] w-full rounded-xl border-2 bg-background px-4 py-3 text-sm font-medium transition-all duration-200",
