...
export const PRODUCT_CATALOG: Product[] = [
  ...
  },
  {
    ...
    nameVi: 'Cá ngừ vây vàng phi lê',
    description: 'Cá ngừ vây vàng tươi, thịt đỏ thẫm, phù hợp làm sashimi',
    image: 'https://images.unsplash.com/photo-1580959375944-57c9ff86aaf4?w=800&q=80',
    unit: 'KG',
    tempClass: 'FROZEN',
    tempRange: '-18°C đến -20°C',
    shelfLifeDays: 450,
    ...
    reorderPoint: 70,
    price: 680000,
    supplier: 'Pacific Ocean Traders',
    origin: 'Nhật Bản',
  ...
  },
  {
    ...
    nameVi: 'Phô mai Parmesan Italia',
    description: 'Phô mai Parmesan chính gốc từ Italia, vị đậm đà',
    image: 'https://images.unsplash.com/photo-1589881133595-c5e3d4e3e6c0?w=800&q=80',
    unit: 'KG',
    tempClass: 'CHILL',
    ...
    reorderPoint: 30,
    price: 850000,
    supplier: 'European Cheese House',
    origin: 'Italia',
    certifications: ['PDO', 'HACCP'],
    isPopular: false,
  ...
  // Vegetables Category
  {
    ...
    description: 'Súp lơ xanh hữu cơ, không thuốc trừ sâu',
